...
pub fn merge(base: &'static Selectors, patch: &PublishPatch) -> Result<Selectors> {
    let mut out = Selectors {
        ...
        schedule_radio_label: Cow::Borrowed(base.schedule_radio_label.as_ref()),
        schedule_date_input: Cow::Borrowed(base.schedule_date_input.as_ref()),
        schedule_picker_header: Cow::Borrowed(base.schedule_picker_header.as_ref()),
        schedule_picker_next: Cow::Borrowed(base.schedule_picker_next.as_ref()),
        schedule_picker_day: Cow::Borrowed(base.schedule_picker_day.as_ref()),
        schedule_time_input: Cow::Borrowed(base.schedule_time_input.as_ref()),
        collection_label: Cow::Borrowed(base.collection_label.as_ref()),
        link_label: Cow::Borrowed(base.link_label.as_ref()),
        activity_label: Cow::Borrowed(base.activity_label.as_ref()),
        mark_label: Cow::Borrowed(base.mark_label.as_ref()),
        mark_ai_keyword: Cow::Borrowed(base.mark_ai_keyword.as_ref()),
        mark_option: Cow::Borrowed(base.mark_option.as_ref()),
    ...
    for (key, value) in selectors {
        ...
        let target: &mut Cow<'static, str> = match key.as_str() {
            ...
            "schedule_radio_label" => &mut out.schedule_radio_label,
            "schedule_date_input" => &mut out.schedule_date_input,
            "schedule_picker_header" => &mut out.schedule_picker_header,
            "schedule_picker_next" => &mut out.schedule_picker_next,
            "schedule_picker_day" => &mut out.schedule_picker_day,
            "schedule_time_input" => &mut out.schedule_time_input,
            "collection_label" => &mut out.collection_label,
            "link_label" => &mut out.link_label,
            "activity_label" => &mut out.activity_label,
            "mark_label" => &mut out.mark_label,
            "mark_ai_keyword" => &mut out.mark_ai_keyword,
            "mark_option" => &mut out.mark_option,
